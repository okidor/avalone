...
public class CharacterEditor 
{
	...
	public CharacterEditor()
	{
		...
		glapi = new AvaloneGLAPI(1040,600,"character editor","negend");
		glapi.enableTextures();
		img0 = glapi.getImgFromName("player0.png");
		img1 = glapi.getImgFromName("player1.png");
		img2 = glapi.getImgFromName("player2.png");
		loadedImg0 = glapi.getIDFromName("player0.png");
		loadedImg1 = glapi.getIDFromName("player1.png");
		loadedImg2 = glapi.getIDFromName("player2.png");
	...
	{
		while (glapi.windowShouldNotClose() && !close) 
    	{
    		glapi.glLoopBegin();
	...
	{
		return System.getProperty("user.dir") + File.separator + "textures" + File.separator + "negend" + File.separator + path;
	}
