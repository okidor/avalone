...
public class GameFile 
{
	...
	public static final GameFile configFile = new GameFile(Const.configPath);
	public static final GameFile masterSaveFile = new GameFile(Const.savePath);
	...
	public void relink(String[] cutLine, int line)
	{
		al.remove(line);
		al.add(line,cutLine);
	}
    ...
    {
    	int taille = Var.rand.nextInt(10);
